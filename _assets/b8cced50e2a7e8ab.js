    ...
    /***/ 605338: function (_, __, __webpack_require__) {
      ...
      (function (__c) {
        ...
        var o_b = function (a, b, c) {
            ...
            return {
              ...
              xs: (d) => {
                if ((d === null || d === void 0 ? void 0 : d.type) !== "dict")
                  throw new f4("record", d);
                const e = {};
                for (const f of Object.keys(a)) {
                  const [g, h] = a[f],
                    k = h.xs(d.value.get(g));
                  k != null && (e[f] = k);
                }
                return e;
              },
          ...
          v_b = function (a) {
            ...
            return {
              hT: function () {
                return a.Ej.Bj
                  ? 3
                  : a.Ej.Egb === "checking" || a.Ej.settings.status === 2
                  ? 1
          ...
          z_b = function (a, b, c, d, e, f) {
            ...
            async function h() {
              ...
              e && p_b({ span: u, ga: e, event: w_b, props: x });
              const { results: y, gf: A, pwa: z } = r();
              if (A != null && g())
                if (
                  (x =
                  ...
                  p === "poll" &&
                    z &&
                    z !== A &&
                    (G = q4({ Gla: y, TD: x.id, JU: z }));
                  G = x_b({ GJa: G, TD: x.id, JU: A });
                  ...
                  d === null ||
                    ...
                    __c.Jj(d, {
                      Xt: O("izckBA"),
                      group: y_b,
                      XQ: { Zw: O("mQhziQ"), onClick: h },
                    });
                  var I = q4({ Gla: G, TD: x.id, JU: A });
                  z && (I = x_b({ GJa: I, TD: x.id, JU: z }));
                  r4(() => {
                    a.Xl({
                      ...B,
            ...
            async function k(v) {
              ...
              if (y) {
                var A = a.Ej,
                  z = q4({ Gla: x.results, TD: y.id, JU: v });
                r4(() => {
                  a.Xl(() => ({
          ...
          t4 = function (a, b) {
            var c;
            return (((c = a.Xha) === null || c === void 0
              ? void 0
              : c.get(a.document.language || "en")) || [])[A_b[b]];
          },
          B_b = async function () {
          ...
          v4 = function (a, b) {
            ...
            return __c.Sr(b, (d) => {
              var e;
              const f =
                (e = c.get(d)) !== null && e !== void 0 ? e : __c.qt(d, a);
              c.set(d, f);
              return f;
            });
          },
          x4 = function (a, b) {
            ...
            __c.w(!0);
            __c.w(!0);
            const { ma: c, a: d, b: e } = __c.mt(a),
              { ma: f, a: g, b: h } = __c.mt(b),
              k = (c + f) / 2;
          ...
          F_b = function ({ direction: a, text: b, background: c }) {
            return {
              id: "header",
              size: "auto",
              fill: c,
              padding: [20, 20, 16, 20],
              content: z4(b, { direction: B4(a) }),
            };
          },
          I_b = function ({
            direction: a,
            ...
            g === 3 || g === 4 || g === 5
              ? ((b = (n = t4(b, "resultsPercentage"))
                  ? o_b(n, [e], b.document.language)
                  : __c.Ob("sUWUOA", [e])),
                (k = {
                  id: "percentage",
                  placement: {
            ...
            switch (b) {
              ...
              case 2:
                return {
                  ...
                  lC: 1,
                  text: C4(
                    t4(a.messages, "submitting") || O("wutQEA"),
                    c,
                    d,
                    v4(e, L_b),
                    f
              ...
              case 4:
                return {
                  ...
                  lC: 1,
                  text: C4(
                    t4(a.messages, "somethingWentWrong") || O("ElTceA"),
                    c,
                    d,
                    v4(e, N_b),
                    f
          ...
          P_b = function ({
            ...
            f =
              f.status === 1
                ? ((h = f.lza) === null || h === void 0 ? void 0 : h.type) ===
                  "ANON"
                  ? t4(b, "yourNameWontBeShared") || O("Gzs/9g")
                  : t4(b, "yourNameWillBeShared") || O("WjcAyg")
                : t4(b, "live") || O("/iw6+Q");
            d = (h = t4(b, "numVotes"))
              ? o_b(h, [d], b.document.language)
              : __c.Ob("6QpLYA", [d]);
            return [
              {
                id: "footer",
          ...
          T_b = function ({ direction: a, rva: b, nw: c, state: d }) {
            const e = x4("#000000", c);
            return {
              type: "layout",
              gridTemplateRows: ["10px", "1fr", "10px"],
              ...
              cells: [
                {
                  ...
                  content: (() => {
                    switch (d) {
                      case 5:
                        return z4(b, { direction: B4(a), color: "#00873d" });
                      case 6:
                        return z4(b, { direction: B4(a), color: "#c8001e" });
                      case 4:
                        return z4(b, { direction: B4(a), color: v4(c, S_b) });
                      default:
                        return z4(b, { direction: B4(a) });
                    }
                  })(),
                },
                d === 5 || d === 6
                ...
                cells: c.map(({ value: p }) => {
                  ...
                  return {
                    ...
                    content: {
                      ...
                      ...T_b({ direction: b, rva: p.label, nw: k, state: q }),
                    },
                  };
                }),
              }),
          ...
          V_b = function ({ direction: a, text: b, E7a: c, wR: d, bN: e }) {
            const f = w4.includes(c),
              { h: g, s: h, ma: k } = __c.aka(c);
            ...
            if (!m || !h || !k) {
              ...
              h =
                (h === null || h === void 0 ? void 0 : h.status) === 1
                  ? ((p = h.lza) === null || p === void 0 ? void 0 : p.type) ===
                    "ANON"
                    ? t4(c, "yourNameWontBeShared") || O("Gzs/9g")
                    : t4(c, "yourNameWillBeShared") || O("WjcAyg")
                  : void 0;
              return [
                V_b({ direction: b, text: e, E7a: k, wR: n, bN: a }),
                {
                  id: "quiz_status",
                  size: "auto",
                  padding: [8, 20, 10, 20],
                  ...
                  cells: [
                    {
                      ...
                      content: {
                        ...
                        fontFamily: d,
                        text: h.Kba(k)
                          ? t4(c, "correctLabel") || O("i3mNPA")
                          : t4(c, "incorrectLabel") || O("As1GTA"),
                        fontSize: W_b,
                        fontWeight: "bold",
                        textAlign: "center",
                        direction: B4(b),
        ...
        var m4 = class {
            ...
            constructor(a, b) {
              this.lw = b;
              this.e0a = (m4.A(this), new WeakMap());
          ...
          t_b = class extends m4 {
            ...
            append(a) {
              a = this.list.value.append(this.lw.Bk(a));
              return c4(this, a);
            }
            prepend(a) {
        ...
        var b0b = l4({
          ...
          F4 = o4({ text2: b0b }, (a) => a.type),
          c0b = l4({ id: ["i", g4("")], label: ["l", F4] }),
          d0b = n4(c0b),
          e0b = n4(g4("")),
          f0b = l4({
        ...
        i4(["poll", "quiz"], "quiz");
        var o0b = o4({ quiz: m0b, poll: n0b }, (a) => a.type);
        var w_b = {
        ...
        var q0b = class {
          ...
          get border() {
            ...
            return { weight: a.border.weight, color: a.border.color, cXa: a.X };
          }
          constructor(a, b) {
            this.vx = a;
            this.H = b;
        ...
        var r0b = class {
          static A(a) {
            __c.P(a, { Ky: k4, $y: k4, KB: k4, nw: k4 });
          }
          get Ky() {
        ...
        __c.jPa = {
          b$a: function (a, b, c, d, e, f, g, h, k) {
            g.sg("forms");
            const { sFb: l } = d !== null && d !== void 0 ? d : {},
              m = h.Av("ui.rendering.form"),
              n = { root: new Y_b(), option: new Y_b() },
              p = new p0b(b);
            return {
              Bra: a0b,
              lw: o0b,
                  ...
                  var r,
                    t = $_b(
                      ...
                      () => {
                        ...
                        x.getSettings({ MFb: () => q.Oe.OV }).subscribe((y) => {
                          ...
                          s0b({ llb: z, B$a: A }) &&
                            x.cFb({ iC: q.Oe.iC, OV: q.Oe.OV }).then(
                              Z_b((H) => {
                                const I = q.Oe.iC;
                                if (H.ok) {
              ...
              render: (q, r) => {
                var t = v_b(q);
                if (l && a) {
                  var v = l.get({ Ypa: q.Oe.id, gg: a, W$: c });
                  v = z_b(q, t, v, e, f, m);
                }
                a: {
                  var u = q.Oe,
                  ...
                  switch (u.type) {
                    ...
                    case "quiz":
                      ...
                      if (Q && M && u) {
                        ...
                        M = A.jra
                          ? void 0
                          : F_b({ direction: z, text: Q.label, background: M });
                        Q = U_b({
                          bN: E_b(v),
                          direction: z,
                          options: Q.options,
